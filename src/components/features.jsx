    ...
    return (
        <div className=" mt-10 border-b border-neutral-100">
            ...
            <div className="py-10 ">
                ...
                <div className="grid place-items-center mt-10 bg-green-800 py-10 px-20 lg:flex justify-center md:gap-10">
                ...
                <div className=" text-center bg-gray ">
                    ...
                    <a href="#"><button className=" mt-5 text-xl font-bold text-white cursor-pointer py-2 px-20 border border-white b-md rounded-md text-center hover:shadow-lg transition hover:bg-white hover:text-green-800">Download</button>
                    </a>
                </div>
            </div>
            </div>
