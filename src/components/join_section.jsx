...
function JoinSection() {
  return (
    <section className="join-section p-10 border border-neutral-200 bg-green-50/40 rounded-lg shadow-md mt-10 mx-10 mb-20 md:flex md:flex-row gap-5 md:items-center mx-5 md:mx-auto max-w-4xl">
        <div>
      ...
      <button className="join-button bg-green-800 mt-5 font-bold text-white cursor-pointer py-2 px-10 border rounded-md text-center hover:shadow-lg transition">Join Now</button>
      </form>
    </section>
  );
}
